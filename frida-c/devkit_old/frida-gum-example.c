 ...
 * Compile with:
 *
 * gcc -fPIC -ffunction-sections -fdata-sections -m32 -march=pentium4 -mfpmath=sse -mstackrealign frida-gum-example.c -o frida-gum-example -L. -lfrida-gum -ldl -lrt -lresolv -lm -pthread -fuse-ld=gold -Wl,--icf=all,--gc-sections,-z,noexecstack -static-libgcc
 *
